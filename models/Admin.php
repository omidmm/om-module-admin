...
class Admin extends \omidmm\admin\components\ActiveRecord implements \yii\web\IdentityInterface
{
    static $rootUser = [
        'admin_id' => 0,
        'username' => 'admin',
        'password' => '$2y$13$tEMlbu9DvkU3RDCg.sZwM.JNScy.HJXFqG.Ew.n5fwcdAPxHsFdla',
        'auth_key' => '$2y$13$tEMlbu9DvkU3RDCg.sZwM.JNScy.HJXFqG.Ew.n5fwcdAPxHsFdla',
        'access_token' => ''
    ];

    public static function tableName()
    {
        return 'progsoft_admins';
    }
    ...
    {
        return [
            'username' => Yii::t('progsoft', 'Username'),
            'password' => Yii::t('progsoft', 'Password'),
        ];
    }
