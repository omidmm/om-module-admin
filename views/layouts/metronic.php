...
$asset = MetronicAsset::register($this);
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="uploads/themes/metronic/layout4/img/logo_progsoft.png" alt="progsoft" class="logo-default" /> </a>
                ...
                <div class="page-actions">
                    ...
                    <a href="<?= Url::to(['/']) ?>" class="btn  blue"> <?= Yii::t('progsoft', 'Open site') ?>
