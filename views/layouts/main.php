...
use yii\helpers\Url;
use omidmm\admin\assets\AdminAsset;
    ...
    <div class="container">
        <div class="wrapper">
            <div class="header">
                ...
                <div class="nav">
                    <a href="<?= Url::to(['/']) ?>" class="pull-left"><i class="glyphicon glyphicon-home"></i> <?= Yii::t('progsoft', 'Open site') ?></a>
                    <a href="<?= Url::to(['/admin/sign/out']) ?>" class="pull-right"><i class="glyphicon glyphicon-log-out"></i> <?= Yii::t('progsoft', 'Logout') ?></a>
                </div>
            </div>
            <div class="main">
