<?php
use yii\db\Schema;
use omidmm\admin\models;

use omidmm\catalog\admin;
use omidmm\shopcart\admin;
use omidmm\article\admin;
use omidmm\carousel\admin\models\Carousel;
use omidmm\faq\admin\admin\models\Faq;
use omidmm\feedback\admin\models\Feedback;
use omidmm\file\admin\models\File;
use omidmm\gallery\admin;
use omidmm\guestbook\admin\models\Guestbook;
use omidmm\news\admin\models\News;
use omidmm\page\admin\models\Page;
use omidmm\subscribe\admin\models\Subscriber;
use omidmm\subscribe\admin\models\History;
...
class m000000_000000_install extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        //INSERT VERSION
        $this->delete(models\Setting::tableName(), ['name' => 'progsoft_version']);
        $this->insert(models\Setting::tableName(), [
            'name' => 'progsoft_version',
            'value' => self::VERSION,
            'title' => 'progsoftCMS version',
